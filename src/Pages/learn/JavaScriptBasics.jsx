...
export default function JavaScriptBasics() {
  const units = [
    ...
    },
    {
      ...
      description: "Interacting with webpage elements using JavaScript",
      lessons: 5,
      duration: "2 hours"
    },
    {
    ...
    },
    {
      ...
      description: "Understanding and creating objects",
      lessons: 3,
      duration: "1 hour"
    },
    {
      title: "Basic Algorithms",
      description: "Solving problems with JavaScript",
      lessons: 4,
      duration: "2 hours"
    },
    {
      title: "Final Project",
      description: "Build an interactive webpage",
      lessons: 3,
      duration: "2.5 hours"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-sky-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-blue-900">JavaScript Foundations</h1>
            <p className="text-blue-700">Learn core programming concepts with JavaScript</p>
          </div>
        </div>
