...
export default function MobileAppDevelopment() {
  const units = [
    ...
    {
      title: "UI Components",
      description: "Building responsive mobile interfaces",
      lessons: 5,
      duration: "2.5 hours"
    },
    {
      title: "State Management",
      description: "Using Redux and Context API",
      lessons: 5,
      duration: "2.5 hours"
    },
    {
      title: "Native Features",
      description: "Accessing device cameras, GPS, and sensors",
      lessons: 4,
      duration: "2 hours"
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-sky-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-blue-900">Mobile App Development</h1>
            <p className="text-blue-700">Building professional iOS and Android apps</p>
          </div>
        </div>
